...
export const listRooms = (page: number) => api<Page<RoomSummary>>(`/chat-service/api-admin/chat/rooms?page=${page}&size=20`)
...
export const getRoomChats = (roomId: string, page: number) =>
  api<Page<Chat>>(`/chat-service/api-admin/chat/rooms/${roomId}/chats?page=${page}&size=50`)
