...
/**
 * member-service 의 내부 API. 토큰(X-Internal-Token)은 {@link com.example.wsservice.api.internal.InternalApiFeignConfig}
...
public interface MemberFeignClient {
    ...
    List<String> blockedBy(@PathVariable("userId") String userId);
}
