...
class KafkaConsumerConfig(
    ...
    @Value("\${spring.kafka.consumer.auto-offset-reset:latest}") private val autoOffsetReset: String,
) {
    ...
    fun consumerFactory(): ConsumerFactory<String, ChatMessage> {
        ...
        val deserializer = JsonDeserializer(ChatMessage::class.java, false).apply { addTrustedPackages("*") }
